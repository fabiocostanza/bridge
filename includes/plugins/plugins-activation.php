...
if(!function_exists('bridge_qode_set_plugins_array_to_install')){
    function bridge_qode_set_plugins_array_to_install(){
        ...
        $default_plugins_array_to_install = array('js_composer', 'elementor', 'bridge-core', 'LayerSlider', 'revslider', 'envato-market', 'qode-twitter-feed', 'qode-instagram-widget', 'qi-addons-for-elementor');
    }
    ...
    function bridge_qode_plugins_list($filter_array = array()){
        $plugins = array(
            ...
            array(
                ...
                'slug'     				=> 'LayerSlider',
                'source'   				=> get_template_directory() . '/plugins/layersliderwp-6.11.8.installable.zip',
                'required' 				=> false,
                'version' 				=> '6.11.8',
                'force_activation' 		=> false,
                'force_deactivation' 	=> false,
	        ...
	        array(
                'name'     				=> esc_html__('Yith WooCommerce Quick View', 'bridge'),
